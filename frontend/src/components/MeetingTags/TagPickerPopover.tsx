...
import { MeetingTag, notifyTagsUpdated, tagService } from "@/services/tagService";
import { TagColorDot } from "./TagChip";

interface TagPickerPopoverProps {
  meetingId: string;
}

// Rendered inside a Radix Popover, which owns closing: outside clicks, Escape and a
// second click on the trigger. A document listener here would reopen it on that click.
export function TagPickerPopover({ meetingId }: TagPickerPopoverProps) {
