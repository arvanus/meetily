...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            summary::context::commands::api_save_summary_context,
            summary::context::commands::api_save_summary_template,
            summary::context::commands::api_get_summary_context,
            summary::context::commands::api_add_context_attachment,
            summary::context::commands::api_remove_context_attachment,
            summary::context::commands::api_open_context_attachment,
            summary::context::commands::api_pick_context_attachment_file,
            // Template commands
